"""TargetExtractor: hybrid fit-markdown + product-tile price gate (design §3.2)."""
...
class TargetExtractor:
    """Target product page: gate on the price signal."""
...
register(TargetExtractor(), "target.com")
