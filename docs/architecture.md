...
| search providers | fallback web search, ordered failover | `SEARCH_PROVIDERS`, `TAVILY_API_KEY`, `BRAVE_API_KEY` |
...
```
┌──────────────┐     ┌──────────────┐     ┌──────────────┐
│ wellisearch  │────▶│ shared PG 18 │     │ Crawl4AI     │
│ (this repo)  │     │ (infra)      │     │ (infra)      │
└──────────────┘     └──────────────┘     └──────────────┘
